...
#Usage:
#python 3_train_model.py --yaml_path ../config/ss_graph_risk_config.yaml  
...
def train_Trainer(learning_config):
    ...
    assert learning_config.model_config['model'] in ['ssmrgcn'], 'This script only supports the SSMRGCN.'
